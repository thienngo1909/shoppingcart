...
<body>
	...
	<div class="customer-info-container">
		...
		<ul>
			<li>Name: ${myCartInfo.customerInfo.name}</li> <!-- trường hợp này ko sử dụng model để truyền dữ liệu từ Controller mà lấy trực tiếp key=myCartInfo trong session value=cartInfo -->
